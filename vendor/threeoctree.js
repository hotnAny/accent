...
(function(THREE) {
    ...
    THREE.Octree = function(parameters) {
        ...
        this.INDEX_OUTSIDE_POS_X = isNumber(parameters.INDEX_OUTSIDE_POS_X) ? parameters.INDEX_OUTSIDE_POS_X :
            0;
        this.INDEX_OUTSIDE_NEG_X = isNumber(parameters.INDEX_OUTSIDE_NEG_X) ? parameters.INDEX_OUTSIDE_NEG_X :
            1;
        this.INDEX_OUTSIDE_POS_Y = isNumber(parameters.INDEX_OUTSIDE_POS_Y) ? parameters.INDEX_OUTSIDE_POS_Y :
            2;
        this.INDEX_OUTSIDE_NEG_Y = isNumber(parameters.INDEX_OUTSIDE_NEG_Y) ? parameters.INDEX_OUTSIDE_NEG_Y :
            3;
        this.INDEX_OUTSIDE_POS_Z = isNumber(parameters.INDEX_OUTSIDE_POS_Z) ? parameters.INDEX_OUTSIDE_POS_Z :
            4;
        this.INDEX_OUTSIDE_NEG_Z = isNumber(parameters.INDEX_OUTSIDE_NEG_Z) ? parameters.INDEX_OUTSIDE_NEG_Z :
            5;
        ...
        this.objectsThreshold = isNumber(parameters.objectsThreshold) ? parameters.objectsThreshold :
            8;
        this.overlapPct = isNumber(parameters.overlapPct) ? parameters.overlapPct : 0.15;
        this.undeferred = parameters.undeferred || false;

        this.root = parameters.root instanceof THREE.OctreeNode ? parameters.root : new THREE.OctreeNode(
            parameters);
    ...
    THREE.Octree.prototype = {
        ...
        extend: function(octree) {
            ...
            if (octree instanceof THREE.Octree) {
                ...
                for (i = 0, l = objectsData.length; i < l; i++) {
                    ...
                    this.add(objectData, {
                        useFaces: objectData.faces,
                        useVertices: objectData.vertices
                    });
        ...
        rebuild: function() {
            ...
            for (i = 0, l = this.objectsData.length; i < l; i++) {
                ...
                if (node instanceof THREE.OctreeNode && !objectData.positionLast.equals(
                        objectData.position)) {
    ...
    THREE.OctreeObjectData.prototype = {
        ...
        update: function() {
            ...
            if (this.face3) {
                ...
                if (this.object.geometry) {
                    ...
                    this.position.copy(this.object.geometry.boundingSphere.center).applyMatrix4(
            ...
            this.radius = this.radius * Math.max(this.object.scale.x, this.object.scale.y, this
                .object.scale.z);
        ...
        getFace3BoundingRadius: function(object, face) {
            ...
            radius = Math.max(centroidToVert.subVectors(centroid, va).length(), centroidToVert.subVectors(
                centroid, vb).length(), centroidToVert.subVectors(centroid, vc).length());
        ...
        getFace4BoundingRadius: function(object, face) {
            ...
            // var centroid = new THREE.Vector3().addVectors(geometry.vertices[face.a], geometry.vertices[
            //     face.b]).add(geometry.vertices[face.c]).divideScalar(3);
    ...
    THREE.OctreeNode = function(parameters) {
        ...
        this.position = parameters.position instanceof THREE.Vector3 ? parameters.position : new THREE
            .Vector3();
        ...
        if (this.tree.scene) {
            ...
            this.visual.scale.set(this.radiusOverlap * 2, this.radiusOverlap * 2, this.radiusOverlap *
                2);
    ...
    THREE.OctreeNode.prototype = {
        ...
        checkGrow: function() {
            ...
            if (this.objects.length > this.tree.objectsThreshold && this.tree.objectsThreshold >
                0) {
        ...
        grow: function() {
            ...
            if (objectsSplit.length > 0) {
                ...
                objectsRemaining = objectsRemaining.concat(this.split(objectsSplit,
                    objectsSplitOctants));
            ...
            if (objectsExpand.length > 0) {
                ...
                objectsRemaining = objectsRemaining.concat(this.expand(objectsExpand,
                    objectsExpandOctants));
        ...
        branch: function(indexOctant) {
            ...
            if (this.nodesByIndex[indexOctant] instanceof THREE.OctreeNode) {
                ...
                offset = this.utilVec31Branch.set(indexOctant & 1 ? radiusOffset : -
                    radiusOffset, indexOctant & 2 ? radiusOffset : -radiusOffset,
        ...
        expand: function(objects, octants) {
            ...
            if (this.tree.root.getDepthEnd() < this.tree.depthMax) {
                ...
                if (objectsExpand.length > 0) {
                    ...
                    infoIndexOutside2 = (infoPotential1.index | 1) !== indexOutsideBitwise1 ?
                        infoPotential1 : infoPotential2;
                    ...
                    infoIndexOutside3 = indexPotentialBitwise1 !== indexOutsideBitwise1 &&
                        ...
                        indexPotentialBitwise2 !== indexOutsideBitwise2 ? infoPotential2 :
                        infoPotential3;
                    ...
                    indexOctantInverse = this.getOctantIndexFromPosition(-octantX, -octantY, -
                        octantZ);
                    ...
                    radiusParent = this.tree.overlapPct > 0 ? overlap / ((0.5 * this.tree.overlapPct) *
                        (1 + this.tree.overlapPct)) : radius * 2;
                    ...
                    offset.set(indexOctant & 1 ? radiusOffset : -radiusOffset, indexOctant & 2 ?
                        radiusOffset : -radiusOffset, indexOctant & 4 ? radiusOffset : -
                        radiusOffset);
                    position = new THREE.Vector3().addVectors(this.position, offset);
        ...
        checkMerge: function() {
            ...
            while (nodeParent.parent instanceof THREE.OctreeNode && nodeParent.getObjectCountEnd() <
                this.tree.objectsThreshold) {
        ...
        checkContract: function() {
            ...
            if (this.nodesIndices.length > 0) {
                ...
                if (outsideHeaviestObjectsCount < this.tree.objectsThreshold && nodeHeaviest instanceof THREE
                    .OctreeNode) {
        ...
        toConsole: function(space) {
            ...
            console.log((this.parent ? space + ' ' : ' '), '+ objects ( ', this.objects.length,
                ' ) ', this.objects);
